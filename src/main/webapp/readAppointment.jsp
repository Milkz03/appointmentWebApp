        ...
        <div class="col">
            <div class="form-floating">
                <select class="form-select" name="appointmentID" id="floatingSelect" aria-label="Floating label select example">
                    ...
                    <% ReadAppointment.availableAppointments();
                        for (int i = 0; i < ReadAppointment.appointmentsIDs.size(); i++) { %>
                    <option value="<%=ReadAppointment.appointmentsIDs.get(i)%>"><%=ReadAppointment.appointmentsIDs.get(i)%></option>
                    <%  } %>
                </select>
